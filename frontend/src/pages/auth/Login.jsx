  ...
  return (
    <AuthLayout tagline="Sign in">
      ...
      <form onSubmit={submit} className="mt-8 space-y-5" data-testid="login-form">
        ...
        <button
          type="button"
          onClick={() => toast("Google login is coming soon — connecting via Emergent Auth in Part 1B.")}
          data-testid="login-google"
          className="w-full flex items-center justify-center gap-3 rounded-full border border-border bg-background hover:bg-accent px-6 py-3 text-sm font-medium transition-colors"
        >
